...
import com.app.ecommerce.activities.HistoryActivity;
...
//            txt_order_total = view.findViewById(R.id.txt_order_total);
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        holder.txt_purchase_code.setText(HistoryActivity.code.get(position));
        holder.txt_order_date.setText(Utils.getFormatedDateSimple(HistoryActivity.date_time.get(position)));
        holder.txt_order_total.setText(HistoryActivity.order_total.get(position));

    }

    @Override
    public int getItemCount() {
        return HistoryActivity.id.size();
    }
