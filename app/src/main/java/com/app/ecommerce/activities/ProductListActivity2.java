...
public class ProductListActivity2 extends AppCompatActivity implements RecyclerAdapterProduct.ProductAdapterListener {
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        if (Utils.isNetworkAvailable(ProductListActivity2.this)) {
